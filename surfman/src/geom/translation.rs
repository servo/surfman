...
use crate::geom::num::*;
use crate::geom::point::{Point2D, Point3D};
use crate::geom::size::Size2D;
use crate::geom::transform2d::Transform2D;
use crate::geom::transform3d::Transform3D;
use crate::geom::vector::{Vector2D, Vector3D};
use crate::geom::UnknownUnit;
use crate::geom::{point2, point3, vec2, vec3, Box2D, Box3D, Rect};
...
///
/// ```
/// use surfman::geom::{Translation2D, Point2D, point2};
/// struct ParentSpace;
/// struct ChildSpace;
...
impl<T, Src, Dst> Translation2D<T, Src, Dst> {
    #[inline]
    /// Creates a new Translation2D instance.
    ...
    ///
    /// ```rust
    /// use surfman::geom::default::Translation2D;
    ///
...
impl<T, Src, Dst> Translation3D<T, Src, Dst> {
    /// Creates a new Translation3D instance.
    #[inline]
    ...
    ///
    /// ```rust
    /// use surfman::geom::default::Translation3D;
    ///
...
mod _2d {
    #[test]
    fn simple() {
        use crate::geom::{rect, Rect, Translation2D};
    ...
    /// Operation tests
    mod ops {
        use crate::geom::default::Translation2D;
...
mod _3d {
    #[test]
    fn simple() {
        use crate::geom::{point3, Point3D, Translation3D};
    ...
    /// Operation tests
    mod ops {
        use crate::geom::default::Translation3D;
