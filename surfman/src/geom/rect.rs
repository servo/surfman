    ...
    T: Copy + Add<T, Output = T>,
{
    ...
    /// Returns the rectangle as a box.
    #[inline]
...
#[cfg(test)]
mod tests {
    use crate::geom::default::{Point2D, Rect, Size2D};
    use crate::geom::side_offsets::SideOffsets2D;
    use crate::geom::{point2, rect, size2, vec2};
