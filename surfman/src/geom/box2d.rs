...
use crate::geom::side_offsets::SideOffsets2D;
    ...
    T: Copy + PartialOrd,
{
    ...
    /// Returns the union between the two boxes.
    #[inline]
...
#[cfg(test)]
mod tests {
    use crate::geom::default::{Box2D, Point2D, SideOffsets2D};
    use crate::geom::point::point2;
    use crate::geom::size::size2;
