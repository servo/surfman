...
use crate::geom::{Rotation3D, Transform3D, UnknownUnit, Vector3D};
...
impl<T: Float + ApproxEq<T>, Src, Dst> RigidTransform3D<T, Src, Dst> {
    ...
    /// returns the result from rotation
    #[inline]
    ...
    /// returns the result from translation
    #[inline]
    ...
    /// returns the object to transform
...
mod test {
    ...
    use crate::geom::default::{Rotation3D, Transform3D, Vector3D};
