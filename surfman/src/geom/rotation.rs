...
use crate::geom::{point2, point3, vec3, Angle, Point2D, Point3D, Vector2D, Vector3D};
use crate::geom::{Transform2D, Transform3D, UnknownUnit};
...
fn simple_rotation_2d() {
    use crate::geom::default::Rotation2D;
...
fn simple_rotation_3d_in_2d() {
    use crate::geom::default::Rotation3D;
    use core::f32::consts::{FRAC_PI_2, PI};
