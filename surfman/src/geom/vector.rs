//! Any kind of thing to do with a vector.
...
use crate::geom::size::{size2, size3, Size2D, Size3D};
use crate::geom::transform2d::Transform2D;
use crate::geom::transform3d::Transform3D;
    ...
    T: Copy + One + Add<Output = T> + Sub<Output = T> + Mul<Output = T>,
{
    ...
    /// ```rust
    /// use surfman::geom::vector::vec2;
    /// use surfman::geom::default::Vector2D;
    ///
    ...
    T: Copy + One + Add<Output = T> + Sub<Output = T> + Mul<Output = T>,
{
    ...
    /// ```rust
    /// use surfman::geom::vector::vec3;
    /// use surfman::geom::default::Vector3D;
    ///
...
mod vector2d {
    use crate::geom::scale::Scale;
    use crate::geom::{default, vector::vec2};
...
mod vector3d {
    use crate::geom::scale::Scale;
    use crate::geom::{default, vector::vec2, vector::vec3};
    #[cfg(feature = "mint")]
    use mint;
