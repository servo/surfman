...
use crate::geom::num::One;

use crate::geom::{Box2D, Box3D, Point2D, Point3D, Rect, Size2D, Vector2D};
...
impl<T, Src, Dst> Scale<T, Src, Dst> {
    ...
    ///
    /// ```rust
    /// use surfman::geom::Scale;
    /// use surfman::geom::num::One;
    /// enum Mm {};
    /// enum Cm {};
    ///
