...
use crate::geom::num::Zero;
use crate::geom::scale::Scale;
use crate::geom::vector::Vector2D;
...
fn from_vectors() {
    ...
    type Box2D = crate::geom::default::Box2D<i32>;
...
mod ops {
    ...
    type SideOffsets2D<T> = crate::geom::default::SideOffsets2D<T>;
    type SideOffsets2DMm<T> = crate::geom::side_offsets::SideOffsets2D<T, Mm>;
    type SideOffsets2DCm<T> = crate::geom::side_offsets::SideOffsets2D<T, Cm>;
