...
pub fn test_depth_and_stencil() {
    ...
    unsafe {
        ...
        gl.read_pixels(
            ...
            gl::DEPTH_COMPONENT,
            gl::FLOAT,
            PixelPackData::Slice(slice::from_raw_parts_mut(
                (&mut depth_value) as *mut f32 as *mut u8,
    ...
    unsafe {
        ...
        gl.read_pixels(
            ...
            gl::UNSIGNED_BYTE,
            PixelPackData::Slice(slice::from_raw_parts_mut(
                (&mut stencil_value) as *mut u8,
                size_of_val(&stencil_value),
            )),
        );
